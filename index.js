...
function navigateTo(page) {
  ...
  const translations = {
    es: {
      ...
      "about-p1":
        "Soy un profesional apasionado con experiencia en [tu campo]. Me especializo en [tus habilidades principales] y me encanta enfrentar nuevos desafíos que me permitan crecer profesionalmente.",
      "about-p2":
        "A lo largo de mi carrera, he desarrollado habilidades en [menciona algunas habilidades clave], lo que me ha permitido [logros importantes]. Mi enfoque siempre ha sido [tu filosofía de trabajo].",
      "about-p3":
        "Fuera del ámbito profesional, disfruto [tus hobbies o intereses], lo que me ayuda a mantener un equilibrio entre mi vida personal y profesional.",
      ...
      "post1-content-intro":
        "El diseño web está en constante evolución, adaptándose a las nuevas tecnologías, preferencias de los usuarios y tendencias estéticas. En 2025, estamos viendo una convergencia fascinante de minimalismo, funcionalidad y experiencias inmersivas que están redefiniendo cómo interactuamos con los sitios web.",
      ...
      "post1-content2":
        "Con el avance de las tecnologías web, los diseños inmersivos están ganando popularidad. Estos incorporan elementos 3D, parallax avanzado, y experiencias interactivas que responden al movimiento del usuario. El objetivo es crear una conexión más profunda entre el usuario y el contenido.",
      "post1-heading3": "3. Modo Oscuro como Estándar",
      "post1-content3":
        "El modo oscuro ha pasado de ser una característica opcional a un estándar de diseño. Además de reducir la fatiga visual y ahorrar batería en dispositivos móviles, los temas oscuros ofrecen oportunidades creativas para destacar elementos clave con contrastes dramáticos.",
      "post1-heading4": "4. Tipografía Experimental",
      "post1-content4":
        "Las fuentes personalizadas y experimentales están tomando protagonismo. Los diseñadores están utilizando tipografías únicas como elemento central del diseño, con tamaños variables, animaciones y disposiciones no convencionales que desafían las normas tradicionales.",
      "post1-heading5": "5. Neomorfismo Evolucionado",
      "post1-content5":
        "El neomorfismo, que combina elementos del skeuomorfismo y el diseño plano, ha evolucionado para ofrecer interfaces que parecen tangibles sin sacrificar la usabilidad. Esta tendencia crea elementos de interfaz que parecen emerger de la propia superficie de la pantalla.",
      ...
      "post2-content-intro":
        "La velocidad de carga de un sitio web es uno de los factores más importantes para el éxito online. Un sitio lento no solo frustra a los usuarios, sino que también afecta negativamente al SEO y las conversiones. En este artículo, compartiré técnicas efectivas para optimizar el rendimiento de tu sitio web.",
      "post2-heading1": "1. Optimización de Imágenes",
      "post2-content1":
        "Las imágenes suelen ser los elementos más pesados de un sitio web. Optimizarlas correctamente puede reducir drásticamente los tiempos de carga:",
      "post2-heading2": "2. Minificación y Compresión",
      "post2-content2":
        "Reducir el tamaño de tus archivos CSS, JavaScript y HTML puede mejorar significativamente los tiempos de carga:",
      "post2-heading3": "3. Aprovecha el Caché del Navegador",
      "post2-content3":
        "Configurar correctamente el caché del navegador permite que los visitantes recurrentes carguen tu sitio mucho más rápido:",
      ...
      "post3-content1":
        "Los asistentes de codificación impulsados por IA como GitHub Copilot, Tabnine y otros están transformando la forma en que los desarrolladores escriben código. Estas herramientas pueden:",
    ...
    it: {
      ...
      "about-p1":
        "Sono un professionista appassionato con esperienza in [il tuo campo]. Mi specializzo in [le tue competenze principali] e adoro affrontare nuove sfide che mi permettano di crescere professionalmente.",
      "about-p2":
        "Durante la mia carriera, ho sviluppato competenze in [menziona alcune competenze chiave], che mi hanno permesso di [risultati importanti]. Il mio approccio è sempre stato [la tua filosofia di lavoro].",
      "about-p3":
        "Al di fuori dell'ambito professionale, mi piace [i tuoi hobby o interessi], che mi aiutano a mantenere un equilibrio tra la mia vita personale e professionale.",
      ...
      "blog-archive-description":
        "Condivido i miei pensieri, esperienze e conoscenze su sviluppo web, design e tecnologia.",
      ...
      "post1-content2":
        "Con l'avanzamento delle tecnologie web, i design immersivi stanno guadagnando popolarità. Questi incorporano elementi 3D, parallasse avanzato ed esperienze interattive che rispondono al movimento dell'utente. L'obiettivo è creare una connessione più profonda tra l'utente e il contenuto.",
      "post1-heading3": "3. Modalità Scura come Standard",
      "post1-content3":
        "La modalità scura è passata dall'essere una caratteristica opzionale a uno standard di design. Oltre a ridurre l'affaticamento visivo e risparmiare batteria sui dispositivi mobili, i temi scuri offrono opportunità creative per evidenziare elementi chiave con contrasti drammatici.",
      "post1-heading4": "4. Tipografia Sperimentale",
      "post1-content4":
        "I caratteri personalizzati e sperimentali stanno assumendo un ruolo di primo piano. I designer stanno utilizzando tipografie uniche come elemento centrale del design, con dimensioni variabili, animazioni e disposizioni non convenzionali che sfidano le norme tradizionali.",
      "post1-heading5": "5. Neomorfismo Evoluto",
      "post1-content5":
        "Il neomorfismo, che combina elementi dello skeuomorfismo e del design piatto, si è evoluto per offrire interfacce che sembrano tangibili senza sacrificare l'usabilità. Questa tendenza crea elementi di interfaccia che sembrano emergere dalla superficie stessa dello schermo.",
      ...
      "post2-content-intro":
        "La velocità di caricamento di un sito web è uno dei fattori più importanti per il successo online. Un sito lento non solo frustra gli utenti, ma influisce anche negativamente sulla SEO e sulle conversioni. In questo articolo, condividerò tecniche efficaci per ottimizzare le prestazioni del tuo sito web.",
      "post2-heading1": "1. Ottimizzazione delle Immagini",
      "post2-content1":
        "Le immagini sono spesso gli elementi più pesanti di un sito web. Ottimizzarle correttamente può ridurre drasticamente i tempi di caricamento:",
      "post2-heading2": "2. Minificazione e Compressione",
      "post2-content2":
        "Ridurre le dimensioni dei tuoi file CSS, JavaScript e HTML può migliorare significativamente i tempi di caricamento:",
      "post2-heading3": "3. Sfrutta la Cache del Browser",
      "post2-content3":
        "Configurare correttamente la cache del browser consente ai visitatori ricorrenti di caricare il tuo sito molto più velocemente:",
      "post2-heading4": "4. Ottimizza il Rendering",
      "post2-content4":
        "Migliorare il modo in cui viene renderizzato il tuo sito può avere un grande impatto sulla percezione della velocità:",
      "post2-heading5": "5. Utilizza CDN",
      "post2-content5":
        "Una Rete di Distribuzione dei Contenuti (CDN) può ridurre drasticamente la latenza servendo i tuoi contenuti da server più vicini ai tuoi utenti:",
      "post2-heading-conclusion": "Conclusione",
      "post2-conclusion":
        "Ottimizzare le prestazioni del tuo sito web non è un'attività una tantum, ma un processo continuo. Utilizza strumenti come Lighthouse, WebPageTest o PageSpeed Insights per misurare i tuoi progressi e scoprire aree di miglioramento. Ricorda che ogni millisecondo conta quando si tratta di trattenere gli utenti e migliorare le conversioni.",
      ...
      "post3-content-intro":
        "L'intelligenza artificiale sta trasformando rapidamente il modo in cui progettiamo e sviluppiamo siti web. Ciò che prima richiedeva settimane di codifica manuale ora può essere realizzato in ore o addirittura minuti con l'aiuto di strumenti basati sull'IA. Esploriamo come questa rivoluzione sta cambiando il panorama dello sviluppo web.",
      "post3-heading1": "1. Generazione di Codice Assistita dall'IA",
      "post3-content1":
        "Gli assistenti di codifica basati sull'IA come GitHub Copilot, Tabnine e altri stanno trasformando il modo in cui gli sviluppatori scrivono codice. Questi strumenti possono:",
    ...
    en: {
      ...
      "about-p1":
        "I'm a passionate professional with experience in [your field]. I specialize in [your main skills] and I love facing new challenges that allow me to grow professionally.",
      "about-p2":
        "Throughout my career, I've developed skills in [mention some key skills], which has allowed me to [important achievements]. My approach has always been [your work philosophy].",
      "about-p3":
        "Outside of the professional realm, I enjoy [your hobbies or interests], which helps me maintain a balance between my personal and professional life.",
      ...
      "post1-content-intro":
        "Web design is constantly evolving, adapting to new technologies, user preferences, and aesthetic trends. In 2025, we're seeing a fascinating convergence of minimalism, functionality, and immersive experiences that are redefining how we interact with websites.",
      "post1-heading1": "1. Minimalism 2.0",
      "post1-content1":
        "Minimalism remains a dominant trend, but it has evolved. It's no longer just about white space and simple designs. Minimalism 2.0 combines simplicity with subtle interactive elements, microinteractions, and strategic color touches that guide user attention without overwhelming the interface.",
      "post1-heading2": "2. Immersive Design",
      "post1-content2":
        "With the advancement of web technologies, immersive designs are gaining popularity. These incorporate 3D elements, advanced parallax, and interactive experiences that respond to user movement. The goal is to create a deeper connection between the user and the content.",
      "post1-heading3": "3. Dark Mode as Standard",
      "post1-content3":
        "Dark mode has gone from being an optional feature to a design standard. In addition to reducing eye strain and saving battery on mobile devices, dark themes offer creative opportunities to highlight key elements with dramatic contrasts.",
      "post1-heading4": "4. Experimental Typography",
      "post1-content4":
        "Custom and experimental fonts are taking center stage. Designers are using unique typography as a central design element, with variable sizes, animations, and unconventional layouts that challenge traditional norms.",
      "post1-heading5": "5. Evolved Neomorphism",
      "post1-content5":
        "Neomorphism, which combines elements of skeuomorphism and flat design, has evolved to offer interfaces that feel tangible without sacrificing usability. This trend creates interface elements that appear to emerge from the screen surface itself.",
      ...
      "post2-content-intro":
        "Website loading speed is one of the most important factors for online success. A slow site not only frustrates users but also negatively affects SEO and conversions. In this article, I'll share effective techniques to optimize your website's performance.",
      "post2-heading1": "1. Image Optimization",
      "post2-content1":
        "Images are often the heaviest elements on a website. Optimizing them correctly can drastically reduce loading times:",
      "post2-heading2": "2. Minification and Compression",
      "post2-content2":
        "Reducing the size of your CSS, JavaScript, and HTML files can significantly improve loading times:",
      ...
      "post2-content5":
        "A Content Delivery Network (CDN) can drastically reduce latency by serving your content from servers closer to your users:",
      "post2-heading-conclusion": "Conclusion",
      "post2-conclusion":
        "Optimizing your website's performance is not a one-time task but an ongoing process. Use tools like Lighthouse, WebPageTest, or PageSpeed Insights to measure your progress and discover areas for improvement. Remember that every millisecond counts when it comes to retaining users and improving conversions.",
      ...
      "post3-content-intro":
        "Artificial intelligence is rapidly transforming how we design and develop websites. What once required weeks of manual coding can now be accomplished in hours or even minutes with the help of AI-powered tools. Let's explore how this revolution is changing the landscape of web development.",
      "post3-heading1": "1. AI-Assisted Code Generation",
      "post3-content1":
        "AI-powered coding assistants like GitHub Copilot, Tabnine, and others are transforming how developers write code. These tools can:",
